...
" PP - Justify the current paragraph
...
" <LEADER> MAPPINGS
""""""""""""""""""""
    " Set the <leader> character here, then load the mappings.  This keeps the
    " mappings files portable.
    let g:mapleader = ","

    runtime! mappings-leader.vim    
    runtime! mappings-word.vim      " Word mappings are longer, using words or abbreviations

" Count the words in the current doc
" Disabling for the nonce, as it slows down moving 'wordwise' through text
" with the 'w' key.
" nnoremap wc :!wc -w %<cr>
